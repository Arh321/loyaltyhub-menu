...
const TotoalPaymentCard = () => {
  ...
  //   useEffect(() => {}, []);
  return (
    <div className=" rounded-t-xl p-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1),0_-2px_4px_-1px_rgba(0,0,0,0.06)] text-base">
      <div className="flex flex-col justify-between gap-2 items-center ">
        ...
        {isOpen ? (
          <div className="flex items-center gap-2  max-w-full">
            ...
            <p className="text-center w-[80%] line-clamp-2">
